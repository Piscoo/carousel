(function (window, undefined) {
    ...
    Carousel.prototype = {
        ...
        switchEffect: function () {
            var carousel = this;
            $(carousel.cardsListArr[carousel.n]).children('.img').css('border-bottom', '5px solid #ffe528');
            $(carousel.cardsListArr[carousel.n]).siblings().children('.img').css('border-bottom', 'none');
